...
class PhytopthoraController extends Controller
{
    public function index()
    {
        // Contoh untuk mengambil nama gejala terkait dengan sebuah penyakit
        $diseaseId = 2; // Ganti dengan ID penyakit yang diinginkan
        ...
        return view('pages.penyakit.antraknosa', compact('symptoms', 'solutions', 'diseaseName', 'diseaseDetail'));
    }
}
