...
class AkhirLine2aController extends Controller
{
    public function index()
    {
        // Mengambil nilai jawaban dari session
        $userAnswers = Session::get('user_answer', []);
        $diseases = Diseases::where('disease_code', 'P5')->get();
        ...
        return view('pages.line2.line2a.akhir-line-2-a', compact('userAnswers', 'diseases', 'solutions'));
    }
